//
//  DetailPlaceViewControllerIpad.m
//  VIVU
//
...
@interface DetailPlaceViewControllerIpad ()

@end

@implementation DetailPlaceViewControllerIpad
@synthesize  dictInfo;
...
{
    [self.delegate disMissDetailViewControllerIpad];
}
...
-(void) addBtnPhototViewDetail:(NSInteger )y
{
    ...
    if ([arrayImages count]>4) {
        ...
        [btnMorePhotos setTitleColor:[UIColor blackColor] forState:UIControlStateNormal];
...
-(void) showDetailPhoto:(id)sender
{
    ...
    if (!photosDetailView) {
        photosDetailView =[[PhotosScrollViewController alloc]initWithNibName:@"PhotosScrollViewControllerIpad" bundle:nil];
    ...
    [self.delegate pushPhotosViewControllerFromMainView:photosDetailView];
